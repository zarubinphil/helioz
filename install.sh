...
if [ "$LANG_CHOICE" = "ru" ]; then
  ...
  2. Я тебя допрашиваю. По одному вопросу за раз, и к каждому сразу даю
     ...
     строку «Ответ» в queue/BRIEF.md - подойдет VS Code, любая IDE,
  ...
  5. Потом еду сам. Один агент работает, другой проверяет, и проверяющий
     отчет первого не читает: смотрит на диск и гоняет команды. Никто не
  ...
  9. Убей меня в любой момент, ничего не пропадет. Все, что я знаю, лежит
  ...
  ночью: все записано, все доказано, любое решение можно переиграть.
